...
| Field | Required | Type | Description |
|-------|----------|------|-------------|
| `id` | Yes | number | Identifier of the group - an auto-incremented integer for ordering. |
| `title` | Yes | string | Title of the group |
...
| `group_id` | No | number | Identifier of the group - an auto-incremented integer for ordering. |
...
```json
{
  "groups": [
    {
      "id": 0,
      "title": "Should I focus solely on job opportunities in Germany?"
    },
    {
      "id": 1,
      "title": "Should I only seek full-time opportunities?"
    },
  ]
  "input_data": [
    {
