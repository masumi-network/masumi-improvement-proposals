...
| [`/provide_input`](#provide-input) | `POST` | ✗ | Provides additional input for a job awaiting input | `job_id`, `input_id`, `input_data` | Success confirmation |
...
| `input_schema` | No | object | Only required when status is "awaiting_input". See [Attachment 01](./MIP-003-Attachement-01.md) for details | <details><summary>View Structure</summary><pre>{<br> "id": "8731ecb3-3bcc-4ebc-b46ff7dd12dd",<br> "input_data": [<br>  "id": "linkedin_url",<br>  "type": "string",<br>  "name": "LinkedIn Profile URL",<br>  "data": {...},<br>  "validations": [...]<br>  ]<br>}</pre></details> |
...
| `input_id` | Yes | string | Input ID awaiting input | `"8731ecb3-3bcc-4ebc-b46ff7dd12dd"` |
...
|-------|----------|------|-------------|
| `id` | Yes | string | Unique identifier of the schema |
