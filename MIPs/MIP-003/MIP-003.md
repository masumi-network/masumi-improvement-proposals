...
| Field | Required | Type | Description | Example |
|-------|----------|------|-------------|---------|
| `id` | Yes | string | Unique identifier for the started job | `18d66eed-6af5-4589-b53a-d2e78af657b6` |
...
|-----------|----------|------|-------------|---------|
| `job_id` | Yes | string | The ID of the job to check | `18d66eed-6af5-4589-b53a-d2e78af657b6` |

<details>
<summary><strong>Example Request</strong></summary>

```
GET https://example-url.com/status?job_id=18d66eed-6af5-4589-b53a-d2e78af657b6
```
</details>
...
| Field | Required | Type | Description | Example |
|-------|----------|------|-------------|---------|
| `input` | Yes | object | Example input data that would be sent in the `/start_job` request | <details><summary>View Structure</summary><pre>{<br>  "full_name": "Alice Johnson",<br>  "email": "alice@example.com",<br>  "job_history": "Software Engineer at XYZ Corp",<br>  "design_style": "Modern"<br>}</pre></details> |
| `output` | Yes | object | Example output containing the result | <details><summary>View Structure</summary><pre>{<br>  "result": "Resume generated successfully"<br>}</pre></details> |
...
```json
{
  ...
  "output": {
    "result": "Resume generated successfully with modern design template. Document includes professional summary, work history, and contact information."
  }
}
```
</details>
