...
| `input_data` | Yes | object | All inputs are to be defined in the /input_schema endpoint and depend on what the Agentic Service expects | <details><summary>View Simple Example</summary><pre>{<br>  "linkedin_url": "https://linkedin.com/in/alice-johnson"<br>}</pre></details> <details><summary>View Group Example</summary><pre>{<br>  "group_id:linkedin_url": "https://linkedin.com/in/alice-johnson"<br>}</pre></details> |
...
```json
{
  ...
  "status_id": "8731ecb3-3bcc-4ebc-b46ff7dd12dd",
  "input_data": {
    "b4bb3f54-4565-404b-a554-b578fc861ef5:linkedin_url": "https://linkedin.com/in/alice-johnson"
  }
}
```
</details>
