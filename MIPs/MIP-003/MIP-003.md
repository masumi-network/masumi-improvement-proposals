...
```json
{
    ...
    "status": "pending|awaiting_payment|awaiting_input|running|completed|failed",  // (Required) Current status of the job. Possible outputs: "pending|awaiting_payment|awaiting_input|running|completed|failed".
...
```json
{
    ...
    "input_data": [
        "{
            ...
            "data": { 
            ... // (Optional) To learn more about data please take a look at the [Attachement 01](./MIP-003-Attachement-01.md)
            },
            "validations": [
            ... // (Optional) To learn more about data please take a look at the [Attachement 01](./MIP-003-Attachement-01.md)
            ]
