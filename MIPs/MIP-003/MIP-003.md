...
| `input_groups` | No | array | All inputs are to be defined in the /input_schema endpoint and depend on what the Agentic Service expects | <details><summary>View Group Example</summary><pre>{<br>  "group_id": {<br>    "linkedin_url": "https://linkedin.com/in/alice-johnson"<br>   }<br>}</pre></details> |
